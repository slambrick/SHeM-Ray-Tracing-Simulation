...
function sample_surface = flatSample(side_len, dist, material)
    V = [-side_len/2, -dist, -side_len/2; ...
         -side_len/2, -dist,  side_len/2; ...
          0,      -dist,  side_len/2; ...
          side_len/2, -dist, -side_len/2; ...
          side_len/2, -dist,  side_len/2];
    F = [1,2,3; ...
    ...
    sample_surface = TriagSurface(V, F, N, flattice, M, mat_lib);
end
